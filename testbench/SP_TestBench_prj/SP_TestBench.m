...
addpath ("/Users/boulderzl/Dropbox/Air Team Folder/Simulation/NCSPICE/build/ncspice_sim/share/qucs-s/octave");
...
[S11]     = 10*log10(abs(loadQucsVariable(Data,"ac.v(ns11)")));
[S12]     = 10*log10(abs(loadQucsVariable(Data,"ac.v(ns12)")));
[S21]     = 10*log10(abs(loadQucsVariable(Data,"ac.v(ns21)")));
[S22]     = 10*log10(abs(loadQucsVariable(Data,"ac.v(ns22)")));
